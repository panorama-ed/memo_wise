...
RSpec.describe MemoWise do
  ...
  describe "#memo_wise" do
    ...
    context "with instance methods" do
      ...
      # Use the instance as the target of "#memo_wise examples"
      let(:target) { instance }
    ...
    context "with class methods" do
      context "when defined with 'def self.'" do
        ...
        # Use the class as the target of "#memo_wise examples"
      ...
      shared_examples "presets memoization" do |overriding:|
        ...
        context "with no args" do
          ...
          it "presets memoization" do
            ...
            expect(Array.new(4) { instance.no_args }).
        ...
        context "with positional args" do
          ...
          it "presets memoization" do
            instance.preset_memo_wise(:with_positional_args, 1, 2) { "preset1" }
            instance.preset_memo_wise(:with_positional_args, 3, 4) { "preset3" }
            ...
            expect(instance.with_positional_args_counter).
        ...
        context "with keyword args" do
          ...
          it "presets memoization" do
            instance.preset_memo_wise(:with_keyword_args, a: 1, b: 2) { "1st" }
            instance.preset_memo_wise(:with_keyword_args, a: 2, b: 3) { "2nd" }
        ...
        context "with special chars" do
          ...
          it "presets memoization" do
            instance.preset_memo_wise(:special_chars?) do
