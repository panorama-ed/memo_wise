...
|`(a, b:)`|1.10x|10.35x|
|`(a, *args)`|2.21x|5.04x|
|`(a:, **kwargs)`|1.61x|6.27x|
|`(a, *args, b:, **kwargs)`|1.04x|2.82x|
...
|--|--|--|--|--|
|`()` (none)|32.97x|3.39x|1.56x|4.05x|
|`(a)`|24.77x|17.17x|12.81x|14.37x|
|`(a, b)`|3.96x|2.82x|2.26x|2.55x|
|`(a:)`|34.58x|29.05x|24.20x|25.62x|
|`(a:, b:)`|6.66x|5.50x|4.97x|5.16x|
|`(a, b:)`|6.10x|5.05x|4.40x|4.81x|
|`(a, *args)`|5.48x|4.03x|3.45x|3.47x|
|`(a:, **kwargs)`|4.02x|3.39x|2.93x|3.07x|
|`(a, *args, b:, **kwargs)`|2.78x|2.44x|2.23x|2.25x|
